...
class XUBB {
    public static $rule = array(
        ...
        array(
            ...
            "<a target=\"_blank\" href=\"\\1\"><img border=\"0\" title=\"单击此在新窗口浏览图片\" src=\"\\1\" alt=\"\\1\" class=\"resizeable\" /></a>",
    ...
    public static function parse($text){
        ...
        $base = c('site.base');
        return str_replace('%base%', $base, preg_replace(self::$rule[0], self::$rule[1], $text));
    }
