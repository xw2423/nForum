...
<form id="adv_form_del" style="display:none" action="<{$base}>/adv/del/<{$advType}>" method="post">
    <input type="hidden" name="aid"/>
    <input type="hidden" name="p" value="<{$page}>"/>
</form>
</body>
<script id="tmpl_adv" type="text/template">
<form id="adv_form" action="<{$base}>/adv/<%=ac%>/<{$advType}>" method="post" class="dialog-form" ENCTYPE="multipart/form-data">
    <ul>
<%if(ac=='add'){%>
...
<form id="addform" action="<{$base}>/adv/add/<{$advType}>" method="post" class="dialog-form" ENCTYPE="multipart/form-data">
    <ul>
    <li><span>图片:</span><input type="file" name="img"/></li>
