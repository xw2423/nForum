$(function(){
    ...
    $('#left-line samp').click(function(){
        ...
        $(this).toggleClass('ico-pos-show', 'ico-pos-hide').data("_show", s?1:0).css('right',s?-7:-12);
        $('#menu').width(s?156:0).children(':not(#left-line)')[s?"show":"hide"]().end().next().css("margin-left", s?162:3);
